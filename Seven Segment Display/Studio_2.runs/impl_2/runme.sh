...
HD_PWD='C:/CoCO/Studio/Studio_2/Studio_2.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log sources_studio2.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sources_studio2.tcl -notrace
