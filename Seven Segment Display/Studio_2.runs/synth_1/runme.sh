...
HD_PWD='C:/CoCO/Studio/Studio_2/Studio_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sources_studio2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sources_studio2.tcl
