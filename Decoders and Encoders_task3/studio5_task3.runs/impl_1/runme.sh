...
HD_PWD='C:/CoCO/Studio/studio5_task3/studio5_task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task3.vdi -applog -m64 -messageDb vivado.pb -mode batch -source task3.tcl -notrace
