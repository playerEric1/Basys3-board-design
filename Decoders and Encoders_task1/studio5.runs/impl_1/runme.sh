...
HD_PWD='C:/CoCO/Studio/studio5/studio5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log studio5_task1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source studio5_task1.tcl -notrace
