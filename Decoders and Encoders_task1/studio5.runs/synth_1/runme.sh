...
HD_PWD='C:/CoCO/Studio/studio5/studio5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log studio5_task1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source studio5_task1.tcl
